...
use crate::interpreter::variant::variant_ops::VariantG;
use crate::interpreter::variant::Variant;
use crate::parser::atom::Atom;

pub fn g_fn(context: &mut Context, _head: &Atom, body: &[Atom]) -> Result<Signal, Backtrace> {
    ...
    for atom in body.iter().skip(1) {
        ...
        match variant.g(&rhs, Some(atom.mark.clone()))? {
